...
\usepackage[frenchb]{babel} % Required to compile in Windows
...
\setkomavar{fromname}{Arnaud Bletterer} % Your name
\setkomavar{fromaddress}{2, Route de Forstheim\\67500 Haguenau\\France} % Your address
\setkomavar{fromphone}{+336 64 32 44 28} % Your phone number
\setkomavar{fromemail}{arnaud.bletterer@etu.unistra.fr} % Your email address
\setkomavar{fromurl}{http://abletterer.fr} % Your personal website
\setkomavar{place}{} % City written before the date, put your city here if you want this
\setkomavar{signature}{Arnaud Bletterer} % Your name as you want it to appear in the signature
...
\fontsize{21}{21}\selectfont\scshape Etudiant en Informatique Graphique} % Your current job title
...
\setkomavar{subject}{Lettre de motivation} % This is the bold text saying 'Cover Letter', remove it if you don't like it
